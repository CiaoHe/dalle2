...
def get_embed_dataset(dataset:str,
    ...
    tsv_file = dataset.value
    map_color = dataset in BGRDatasets
    dataset = MMTSVEmbed_Dataset(tsv_file=tsv_file, lineidx_file=lineidx_file, map_color=map_color, image_transforms=image_transforms, clip_name='ViT-B/32', key='text')
    return dataset, tsv_file